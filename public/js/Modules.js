...
/***/ "./resources/js/components/Settings/Modules/Modules.js":
/*!*************************************************************!*\
  !*** ./resources/js/components/Settings/Modules/Modules.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../Services */ "./resources/js/components/Services/index.js");
...
function (_React$Component) {
  ...
  function Modules() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Modules).call(this));

    _defineProperty(_assertThisInitialized(_this), "deleteModule", function (event) {
      event.preventDefault();

      if (confirm('Delete Module? This action will erase all the data related to the module.')) {
        _Services__WEBPACK_IMPORTED_MODULE_4__["moduleService"].settDeleteModule(event.target.value).then(function (response) {
          if (response.status !== 200) {
            console.log('Error', response.status);
            return;
          }
    ...
    _defineProperty(_assertThisInitialized(_this), "showNewModule", function () {
      _this.setState({
  ...
  _createClass(Modules, [{
    ...
    value: function getModules() {
      ...
      _Services__WEBPACK_IMPORTED_MODULE_4__["moduleService"].settGetModules().then(function (response) {
        if (response.status !== 200) {
          console.log('Error', response.status);
          return;
        }
    ...
    key: "saveModule",
    value: function saveModule(values) {
      var _this3 = this;

      _Services__WEBPACK_IMPORTED_MODULE_4__["moduleService"].settSaveModule(values).then(function (response) {
        if (response.status !== 200) {
          console.log('Error', response.status);
          return;
        }
    ...
    value: function render() {
      ...
      var modules = this.state.moduleList.map(function (module, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_ListGroup__WEBPACK_IMPORTED_MODULE_7__["default"].Item, {
          key: index
          ...
          sm: 1
        }, index += 1), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_6__["default"], {
          sm: 2
        }, module.code), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_6__["default"], {
          sm: 3
        }, module.module_name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_6__["default"], null, module.name ? module.name : 'Unassigned'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_6__["default"], null, module.email ? module.email : '-'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_6__["default"], {
          sm: 1
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
          value: module.id,
          onClick: _this4.deleteModule,
      ...
      var validations = yup__WEBPACK_IMPORTED_MODULE_3__["object"]().shape({
        moduleCode: yup__WEBPACK_IMPORTED_MODULE_3__["string"]().required("This field is required."),
        moduleName: yup__WEBPACK_IMPORTED_MODULE_3__["string"]().required("This field is required."),
        lecturer: yup__WEBPACK_IMPORTED_MODULE_3__["string"]().matches(/[^0]/, "error cerca") //test //estoy cerca

      });
      var newModule = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_2__["Formik"], {
        initialValues: initialValues,
        onSubmit: this.saveForm //Form validation 
        ,
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
          ...
          htlmfor: "moduleCode",
          className: "mb-0"
        }, "Code:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_2__["Field"], {
          autoFocus: true,
          name: "moduleCode",
          placeholder: "New module code",
          type: "input",
          ...
          htmlFor: "moduleName",
          className: "mb-0"
        }, "Name:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_2__["Field"], {
          name: "moduleName",
          type: "text",
          ...
          htmlFor: "",
          className: "mb-0"
        }, "Lecturer:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("select", {
          name: "lecturer",
          ...
          value: "0",
          defaultValue: true
        }, "Select"), _this4.state.userList.map(function (user) {
          ...
          className: "btn-sm border shadow-sm btn-outline-light",
          onClick: _this4.showNewModule
        }, "Close")))));
      });
      var newModuleForm = "";

      if (!this.state.newModule) {
        newModuleForm = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          onClick: this.showNewModule,
          className: "btn-sm border shadow-sm btn-outline-light"
        }, "Add Module");
      } else {
        newModuleForm = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, newModule);
      }

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Modules"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap_ListGroup__WEBPACK_IMPORTED_MODULE_7__["default"].Item, null, newModuleForm), this.state.loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
...
/***/ 3:
/*!*******************************************************************!*\
  !*** multi ./resources/js/components/Settings/Modules/Modules.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\webfeedback\resources\js\components\Settings\Modules\Modules.js */"./resources/js/components/Settings/Modules/Modules.js");
