...
/***/ "./resources/js/components/Services/index.js":
/*!***************************************************!*\
  !*** ./resources/js/components/Services/index.js ***!
  \***************************************************/
/*! exports provided: userService, getAuthHeader, subtitleService, studentService, templateService, reviewService, moduleService, markingService, learnService, groupIitemService, markService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupIitemService", function() { return groupIitemService; });
...
var userService = {
  ...
  setUserId: setUserId,
  getModulesUser: getModulesUser,
  setSession: setSession,
  logOut: logOut
};
var baseURL = '/webfeedback/public/api/';
/**login functions**/
...
function setUserId() {
  ...
  axios.get(baseURL + 'user').then(function (response) {
...
function getSession(token_name) {
  var info = localStorage.getItem(token_name);
...
function getSubTitleInfo() {
  ...
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
  return axios.get(baseURL + 'module/subtitle/', {
    params: params
  });
} //STUDENT SERVICES
...
var studentService = {
  getList: getList,
  sendEmailStudents: sendEmailStudents
...
function getList() {
  ...
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
  return axios.get(baseURL + 'module/students/', {
    params: params
  });
...
function sendEmailStudents(moduleId, templateId, studentList) {
  ...
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
  return axios.get(baseURL + 'module/sendmail', {
    params: params
  });
...
function getTemplate() {
  ...
  var templateId = getSession('d_token').as;
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
...
function getDocument() {
  ...
  return axios.get(baseURL + 'markingsheet/review', {
    params: params
  });
}
...
function generatePDF() {
  ...
  return axios.get(baseURL + 'markingtemplate/pdf', {
    params: params
  });
}

function getTitle() {} //make a function to get the data to show on subtitles
...
var moduleService = {
  settGetModules: settGetModules,
  settSaveModule: settSaveModule,
  settDeleteModule: settDeleteModule
};
...
var markingService = {
  settGetTemplates: settGetTemplates,
  settGetModTemplates: settGetModTemplates,
  settGetUnTemplates: settGetUnTemplates,
  settSaveTemplate: settSaveTemplate,
  settDelTemplate: settDelTemplate,
  settUpdateTemplate: settUpdateTemplate
...
function settUpdateTemplate(moduleId, templateId) {
  ...
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
  return axios.get(baseURL + 'settings/templates/assgin/', {
    params: params
  });
}
...
function settDelTemplate(moduleId, templateId) {
  ...
  return axios.get(baseURL + 'settings/templates/delete', {
    params: params
  });
} //LEARNING OUTCOMES
...
var learnService = {
  settGetLearn: settGetLearn,
  settSaveLearn: settSaveLearn,
  settDelLearn: settDelLearn
};
...
function settGetLearn() {
  ...
  var templateId = getSession('sett_token').set;
  axios.defaults.headers.common['Authorization'] = getAuthHeader();
...
var groupIitemService = {
  //TEMPLATE TITLE
  settTemplateName: settTemplateName,
  //GROUPS
  settGetGroup: settGetGroup,
  settSaveGroup: settSaveGroup,
  settDelGroup: settDelGroup,
  //ITEMS
  settDelItem: settDelItem,
  settSaveItem: settSaveItem,
  settGetItem: settGetItem
}; //Template
...
var markService = {
  getMakrStudents: getMakrStudents
};
...
function getMakrStudents(moduleId, templateId) {
  ...
  return axios.get(baseURL + 'settings/students/feedback', {
    params: params
  });
}
...
/***/ "./resources/js/components/Settings/Template/Template.js":
/*!***************************************************************!*\
  !*** ./resources/js/components/Settings/Template/Template.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Services */ "./resources/js/components/Services/index.js");
...
function (_React$Component) {
  ...
  function Template() {
    ...
    _defineProperty(_assertThisInitialized(_this), "deleteTemplate", function (event) {
      //
      event.preventDefault();

      if (confirm('Delete Template? This action will erase all the data related to the template    .')) {
        _Services__WEBPACK_IMPORTED_MODULE_2__["markingService"].settDelTemplate(event.target.value).then(function (response) {
    ...
    _defineProperty(_assertThisInitialized(_this), "showNewTemplate", function () {
      _this.setState({
        newModule: !_this.state.newModule
      });
    });

    _defineProperty(_assertThisInitialized(_this), "saveForm", function (values, _ref) {
      var resetForm = _ref.resetForm;
      _Services__WEBPACK_IMPORTED_MODULE_2__["markingService"].settSaveTemplate(values).then(function (response) {
        return _this.handleResponse(response);
      });
      resetForm({});
    });

    _defineProperty(_assertThisInitialized(_this), "handleGroupsClick", function (templateId) {
      return function (event) {
        //
        _Services__WEBPACK_IMPORTED_MODULE_2__["userService"].setSession('sett_token', {
          "set": templateId
        });

        _this.props.history.push("/webfeedback/public/settings/templates/groups");
      };
    });

    _defineProperty(_assertThisInitialized(_this), "handleOutClick", function (templateId) {
      return function (event) {
        //
        _Services__WEBPACK_IMPORTED_MODULE_2__["userService"].setSession('sett_token', {
          "set": templateId
        ...
        _this.props.history.push("/webfeedback/public/settings/templates/outcomes");
      };
    });
  ...
  _createClass(Template, [{
    ...
    value: function getTemplates() {
      ...
      _Services__WEBPACK_IMPORTED_MODULE_2__["markingService"].settGetTemplates().then(function (response) {
        if (response.status !== 200) {
          console.log('Error', response.status);
          return;
        }
    ...
    value: function render() {
      ...
      var emptyList = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
        className: "text-muted"
      }, "loading...");
      var initialValues = {
        templateTitle: ""
      };
      var validations = yup__WEBPACK_IMPORTED_MODULE_5__["object"]().shape({
        templateTitle: yup__WEBPACK_IMPORTED_MODULE_5__["string"]().required("This field is required.")
      });
      var newTemplate = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_4__["Formik"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
          onSubmit: handleSubmit,
          autoComplete: "off"
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Row__WEBPACK_IMPORTED_MODULE_7__["default"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 4
          ...
          className: "mb-0"
        }, "Template title:"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_4__["Field"], {
          name: "templateTitle",
          type: "input",
          autoFocus: true,
        ...
        }))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 4
        ...
        }, "Save"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          className: "btn-sm border shadow-sm btn-outline-light",
          onClick: _this3.showNewTemplate
        }, "Close")))));
      });
      var newTemplateForm = "";

      if (!this.state.newModule) {
        newTemplateForm = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          onClick: this.showNewTemplate,
          className: "btn-sm border shadow-sm btn-outline-light"
        }, "Add Template");
      } else {
        newTemplateForm = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, newTemplate);
      }

      var templates = this.state.templateList.map(function (template, index) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_ListGroup__WEBPACK_IMPORTED_MODULE_9__["default"].Item, {
          key: index += 1
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Row__WEBPACK_IMPORTED_MODULE_7__["default"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 1
        }, index), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 5
        }, template.title), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 2
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          className: "btn-sm border shadow-sm btn-outline-light",
          onClick: _this3.handleGroupsClick(template.id)
        }, "Details\u279C")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 3
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          className: "btn-sm border shadow-sm btn-outline-light",
          onClick: _this3.handleOutClick(template.id)
        }, "Learn Outcomes\u279C")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_Col__WEBPACK_IMPORTED_MODULE_8__["default"], {
          sm: 1
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
          className: "btn-sm border shadow-sm btn-outline-light",
          value: template.id,
          onClick: _this3.deleteTemplate
        }, "x"))));
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h1", null, "Marking templates"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_bootstrap_ListGroup__WEBPACK_IMPORTED_MODULE_9__["default"].Item, null, newTemplateForm), !this.state.templateList.length > 0 ? emptyList : templates);
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["withRouter"])(Template));

/***/ }),

/***/ 5:
/*!*********************************************************************!*\
  !*** multi ./resources/js/components/Settings/Template/Template.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\webfeedback\resources\js\components\Settings\Template\Template.js */"./resources/js/components/Settings/Template/Template.js");
